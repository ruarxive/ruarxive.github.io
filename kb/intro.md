...
Если вы только начинаете заниматься архивацией:

1. **[Быстрый старт: архивация за 5 минут](/kb/guides/quick-start-5min)** — начните с простых инструментов
2. **[Использование утилиты wget](/kb/guides/wget)** — изучите основы командной строки
3. **[Как создать цифровой архив сайтов](/kb/instruments/howto-collect/make-copy-website)** — полное руководство по архивации сайтов
...
Если вы хотите углубиться в технические детали:

1. **[Создание кастомных workflow](/kb/guides/custom-workflows)** — автоматизация процессов
2. **[Обработка WARC](/kb/instruments/tools/warc-processing)** — работа с архивными файлами
3. **[BagIt формат](/kb/instruments/file-formats/bagit)** — стандарты упаковки архивов
